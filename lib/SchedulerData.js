            ...
            this.events.forEach(function (item) {
                ...
                if (resourceEventsList.length > 0) {
                    ...
                    if (typeof reId === "undefined") {
                        pos = 0;
                        t = 0;
                    } else if (reId === resourceEvents.slotId) {
                        pos = t + 1;
                        t++;
                    } else {
                        pos = 0;
                    ...
                    resourceEvents.headerItems.forEach(function (header, index) {
                        ...
                        if (headerEnd > eventStart && headerStart < eventEnd) {
                            ...
                            var eventCount = events.filter(function (event) {
                                return event.resourceId === resourceEvents.slotId;
                            });
                            resourceEvents.rowMaxCount = eventCount.length;
                ...
                initRenderData.forEach(function (resourceEvents) {
                    ...
                    resourceEvents.headerItems.forEach(function (headerItem) {
                        ...
                        if (_this5.behaviors.getSummaryFunc !== undefined) {
                            ...
                            headerItem.summary = _this5.behaviors.getSummaryFunc(_this5, _events, resourceEvents.slotId, resourceEvents.slotName, headerItem.start, headerItem.end);
